...
module "azure-vms-site1" {
  source          = "./modules/terraform-azurerm-vms"
  prefix          = "site-vm-test"
  subscription_id = var.subscription_id
  client_id       = var.client_id
  client_secret   = var.client_secret
  tenant_id       = var.tenant_id
  location        = local.azure-vms-site1.region
  cidr_block      = local.azure-vms-site1.cidr_block
...
//  client_secret   = var.client_secret
//  tenant_id       = var.tenant_id
//  location        = local.azure-vms-site2.region
//  cidr_block      = local.azure-vms-site2.cidr_block
//  vm_size         = "Standard_D2s_v3" # Standard_D2s_v3, Standard_B2s | For more info https://azureprice.net/
//}
